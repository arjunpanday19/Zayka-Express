...
const Footer = () => {
  return (
    <div className="footer py-3 text-white" style={{ backgroundColor: "#0F172A" }}>
        ...
        <footer className="py-5">
          ...
          <div className="d-flex justify-content-between pt-4 mt-4 border-top">
            <p className="text-white">
              &copy; 2025 Company, Inc. All rights reserved. <br/> Made with <i className="bi bi-heart-fill text-danger"></i> by Arjun Panday.
            </p>
